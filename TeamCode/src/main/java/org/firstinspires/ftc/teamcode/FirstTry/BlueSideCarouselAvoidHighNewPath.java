...
@com.qualcomm.robotcore.eventloop.opmode.Autonomous(name = "Blue Side Carousel Avoid High new path")
public class BlueSideCarouselAvoidHighNewPath extends LinearOpMode{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        //drive into carousel
        robot.driveToPosition(13,driveSpeed/2,this, true);
