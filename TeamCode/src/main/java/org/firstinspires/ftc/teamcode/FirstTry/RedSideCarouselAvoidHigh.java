...
@com.qualcomm.robotcore.eventloop.opmode.Autonomous(name = "Red Side Carousel Avoid high")
public class RedSideCarouselAvoidHigh extends LinearOpMode{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if(position!=2){
            ...
            robot.rotate(-25,rotateSpeed,this);
        ...
        robot.driveAndStop(-22,driveSpeed,this, true);
